    ...
    <body>
        <div class="font-sans text-gray-900 antialiased">
            <div class="min-h-screen flex flex-col sm:justify-center items-center pt-6 sm:pt-0 bg-[#f8f4f3]">
                <div>
                    <a href="/">
                        <h2 class="font-bold text-3xl">AN<span class="bg-[#f84525] text-white px-2 rounded-md">PH51578</span></h2>
                    </a>
                </div>
                ...
                <div class="w-full sm:max-w-md mt-6 px-6 py-4 bg-white shadow-md overflow-hidden sm:rounded-lg">
                  <form action="index.php?act=login" method="post" >
                        ...
                        <div>
                            ...
                            <input type='text' 
                                class="w-full rounded-md py-2.5 px-4 border text-sm outline-[#f84525]"   placeholder="Username" name="username"/>                        
                        </div>
                        ...
                        <div class="flex items-center justify-end mt-4">
                                <a class="hover:underline text-sm text-gray-600 hover:text-gray-900 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500" href="index.php?act=forgotpass">
                            ...
                            <input  type="submit" class = 'ms-4 inline-flex items-center px-4 py-2 bg-[#f84525] border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-red-800 focus:bg-gray-700 active:bg-gray-900 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 transition ease-in-out duration-150'name="dangnhap" value="Login "/>

                        </div>
                        <div class="flex items-center justify-end mt-4">
                        <p class="mt-12 text-xs text-center font-light text-gray-400"> Don't have an account? <a href="index.php?act=register" class="text-black font-medium"> Create One </a>  </p> 
                        </div>
                    </form>                
                </div>
            </div>

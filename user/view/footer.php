            ...
            <div class="flex flex-wrap flex-grow mt-10 -mb-10 text-center md:pl-20 md:mt-0 md:text-left">
                ...
                <div class="w-full px-4 lg:w-1/4 md:w-1/2">
                    ...
                    <nav class="mb-10 list-none">
                        ...
                        <li class="mt-3">
                            <a class="text-gray-500 cursor-pointer hover:text-gray-900">0388 927 126</a>
                        </li>
                    </nav>
                </div>
            </div>
...
<script>
document.getElementById('searchInput').addEventListener('keyw', function(event) {
    if (event.key === 'Enter') {
...
function respondToUser(userMessage) {
    ...
    setTimeout(() => {
        addBotMessage("Chào bạn tôi có thể giúp gì.");
    }, 500);
}

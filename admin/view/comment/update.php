...
if (is_array($commentup)) {
    extract($commentup);
}
?>

<div class="max-w-2xl mx-auto bg-white p-16 mt-3">
<form action="index.php?act=updatecompro" method="POST" enctype="multipart/form-data">
        ...
        <div class="mb-6">
            ...
            <input type="" id="" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5             dark:placeholder-gray-400 dark:text-black dark:focus:ring-blue-500 dark:focus:border-blue-500" value="<?= $Feedback_id ?>" disabled>
        </div>
        ...
        <div class="mb-6">
            ...
            <select name="Products_id" id="" class="form-control">
                        <?php foreach ($productselect as $rowpro) { ?>
                            <option <?= $rowpro['Products_id']  === $Products_id ? 'selected' : '' ?> value="<?= $rowpro['Products_id'] ?>"><?= $rowpro['Products_name'] ?></option>
        ...
        <div class="mb-6">
            ...
            <select name="User_id" id="" class="form-control">
                        <?php foreach ($userselect as $rowuser) { ?>
                            <option <?= $rowuser['User_id']  === $User_id ? 'selected' : '' ?> value="<?= $rowuser['User_id'] ?>"><?= $rowuser['User_name'] ?></option>
        ...
        <div class="mb-6">
            ...
            <select class="form-control" name="Star" id="Star" required>
                        ...
                        <option value="1" <?= $commentup['Star'] == 1 ? 'selected' : '' ?>>1 star</option>
                        <option value="2" <?= $commentup['Star'] == 2 ? 'selected' : '' ?>>2 stars</option>
                        <option value="3" <?= $commentup['Star'] == 3 ? 'selected' : '' ?>>3 stars</option>
                        <option value="4" <?= $commentup['Star'] == 4 ? 'selected' : '' ?>>4 stars</option>
                        <option value="5" <?= $commentup['Star'] == 5 ? 'selected' : '' ?>>5 stars</option>
                    </select>
        </div>

        <div class="mb-6">
            <label for="Reviews" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Reviews</label>
            <input type="text" id="Reviews" name="Reviews" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5             dark:placeholder-gray-400 dark:text-black dark:focus:ring-blue-500 dark:focus:border-blue-500" value="<?= $Reviews ?>">
        </div>

        <div class="mb-6">
            <label for="CreatedAt" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">CreatedAt</label>
            <input type="date" id="CreatedAt" name="CreatedAt" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5             dark:placeholder-gray-400 dark:text-black dark:focus:ring-blue-500 dark:focus:border-blue-500" value="<?= $CreatedAt ?>">
        </div>
        ...
        <input type="hidden" class="" name="Feedback_id" value="<?= $Feedback_id ?>">

...
<form action="index.php?act=createproduct" method="POST" enctype="multipart/form-data" >
    <div class="grid gap-6 mb-6 lg:grid-cols-2">
        <div>
            ...
            <input type="number" id="Products_id"  name="Products_id" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5           dark:placeholder-gray-400 dark:text-black dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="1" readonly >
        </div>

        <div>
            <label for="Products_name" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Products-name</label>
            <input type="text" id="Products_name" name="Products_name" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5           dark:placeholder-gray-400 dark:text-black dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Doe" >
        </div>
        <div>
    ...
    <div class="mb-6">
        ...
        <input type="file" name="Products_img" id="" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5           dark:placeholder-gray-400 dark:text-black dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Image" readonly>
    </div> 

    <div class="mb-6">
        <label for="Products_sku" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Sku</label>
        <input type="text" id="Products_sku" name="Products_sku" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5           dark:placeholder-gray-400 dark:text-black dark:focus:ring-blue-500 dark:focus:border-blue-500"      >
    </div> 

    <div class="mb-6">
        <label for="Products_Sold" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Sold</label>
        <input type="number" id="Products_Sold" name="Products_Sold" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5           dark:placeholder-gray-400 dark:text-black dark:focus:ring-blue-500 dark:focus:border-blue-500"      >
    </div> 

    <div class="mb-6">
        <label for="Products_brand" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Brand</label>
        <input type="text" id="Products_brand" name="Products_brand" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5           dark:placeholder-gray-400 dark:text-black dark:focus:ring-blue-500 dark:focus:border-blue-500"      >
    </div> 

    <div class="mb-6">
        <label for="Products_Feedback" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Feedback</label>
        <input type="text" id="Products_Feedback" name="Products_Feedback" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5           dark:placeholder-gray-400 dark:text-black dark:focus:ring-blue-500 dark:focus:border-blue-500"      >
    </div> 

    <div class="mb-6">
        <label for="Created_at" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Created_at</label>
        <input type="date" id="Created_at" name="Created_at" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5           dark:placeholder-gray-400 dark:text-black dark:focus:ring-blue-500 dark:focus:border-blue-500"      >
    </div> 

    <div class="mb-6">
        <label for="Updated_at" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Updated_at</label>
        <input type="date" id="Updated_at" name="Updated_at" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5           dark:placeholder-gray-400 dark:text-black dark:focus:ring-blue-500 dark:focus:border-blue-500"      >
    </div> 
    ...
    <input type="submit" name="done"  class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" value="Done"/>
    <br>
